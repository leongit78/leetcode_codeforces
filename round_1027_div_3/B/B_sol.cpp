...
void task()
{
    ...
    // Если у макс. кол-ва "хороших" пар (n/2) и нужного кол-ва "хороших"(k) пар ОДИНАКОВАЯ четность -> YES, только если единиц и нулей НЕЧЕТНОЕ кол-во. Запишем проще: (n/2 - k) % 2 == n1 % 2.
    // Если у макс. кол-ва "хороших" пар (n/2) и нужного кол-ва "хороших"(k) пар РАЗНАЯ четность -> YES, только если единиц и нулей ЧЕТНОЕ кол-во. Запишем проще: (n/2 - k) % 2 == n1 % 2
    
    // Вывод: YES <=> 1) Хватает единиц и нулей: n1 - upr >= 0 && n2 - upr >= 0. 2) (n/2 - k) % 2 == n1 % 2 .
